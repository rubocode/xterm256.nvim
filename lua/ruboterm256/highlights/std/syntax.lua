...
local M = {
	...
	Identifier = { fg = uno.uno_3, bg = core.Empty, style = sty.default },
	Function = { fg = uno.uno_2, bg = core.Empty, style = sty.Empty },
	Statement = { fg = duo.duo_1, bg = core.Empty, style = sty.default },
	...
	Operator = { fg = core.syntax_accent, bg = core.Empty, style = sty.default },
	...
	--  Define = { fg = duo.duo_2, bg = core.Empty, style = sty.default },
	--  Macro = { fg = uno.uno_3, bg = core.Empty, style = sty.Empty },
	--  PreCondit = { fg = aux.Red1, bg = core.Empty, style = sty.Empty },
	Type = { fg = duo.duo_1, bg = core.Empty, style = sty.default },
