...
local M = {
	...
	Identifier = { fg = uno.uno_3, bg = nil, style = sty.none },
	Function = { fg = uno.uno_2, bg = nil, style = nil },
	Statement = { fg = duo.duo_1, bg = nil, style = sty.none },
	...
	Operator = { fg = core.syntax_accent, bg = nil, style = sty.none },
	...
	--  Define = { fg = duo.duo_2, bg = nil, style = sty.none },
	--  Macro = { fg = uno.uno_3, bg = nil, style = nil },
	--  PreCondit = { fg = aux.Red1, bg = nil, style = nil },
	Type = { fg = duo.duo_1, bg = nil, style = sty.none },
