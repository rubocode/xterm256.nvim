...
M.CHANGES = {
	...
	Conceal = { fg = nil, bg = core.Empty, style = nil },
	Cursor = { fg = core.syntax_bg, bg = core.syntax_accent, style = nil },
	CursorIM = { fg = nil, bg = core.Empty, style = nil },
	...
	ErrorMsg = { fg = core.syntax_color_removed, bg = core.syntax_bg, style = sty.default },
	VertSplit = { fg = core.syntax_fold_bg, bg = nil, style = sty.default },
	...
	CursorLineNr = { fg = uno.uno_2, bg = nil, style = sty.default },
	MatchParen = { fg = core.syntax_bg, bg = core.syntax_accent, style = nil },
	Italic = { fg = nil, bg = core.Empty, style = sty.italic },
	...
	StatusLine = { fg = core.syntax_fg, bg = core.syntax_cursor_line, style = sty.default },
	StatusLineNC = { fg = uno.uno_4, bg = nil, style = nil },
	TabLine = { fg = uno.uno_4, bg = nil, style = nil },
	TabLineFill = { fg = nil, bg = core.Empty, style = sty.default },
